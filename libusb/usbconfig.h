...
#define  USB_CFG_VENDOR_ID       0xCC, 0x16 /* = 0x16c0 = 5824 = voti.nl */
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xEF, 0x15 /* = 0x05dc = 1500 */
 ...
 */
#define	USB_CFG_VENDOR_NAME     'S', 'a', 'i', 'm', 'o', 'n'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'A', 'V', 'R', 'D', 'a', 't', 'a'
#define USB_CFG_DEVICE_NAME_LEN 7
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   '2','0','0','9','0','8','2','2'
 ...
 */
#define USB_CFG_INTERFACE_CLASS     0x08   /* define class here if not at device level */
#define USB_CFG_INTERFACE_SUBCLASS  0x06
